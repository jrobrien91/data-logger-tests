# Apogee SN-500 SDI-12 Example

"""
Adapted from LinkPython `sdi12.py` with SDI-12 commands from the 
Apogee SN-500 manual 
"""
...
def sdi_bus_valid(sdi_bus):
    ...
    :param sdi_bus: string indicating bus: "Port1", "Port2", or "
